...
The original animation reference and extracted reference masks do not have a confirmed redistribution license and are not part of the public repository or production build. An optional ignored `local-reference/` pack is supported for local development only; its use does not grant redistribution rights.
